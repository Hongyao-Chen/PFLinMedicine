...
if __name__ == "__main__":
    ...
    parser.add_argument('-lam', "--lamda", type=float, default=0.01,
    ...
    # Ditto / FedRep
    parser.add_argument('-pls', "--plocal_epochs", type=int, default=5)
    # MOON / FedCAC / FedLC
    ...
    parser.add_argument('-L', "--L", type=float, default=0.1)
    # FedGen
    ...
    # ours
    parser.add_argument('-global_lr', type=float, default=0.03)
    parser.add_argument('-ar_lr', type=float, default=0.5)
